...
def main():
    ...
    in_file = 'offline/out-kjl-tune_qs_k/src_dst/iat_size-header_False/MAWI1_2020/before_proj_False-gs_True/KJL-QS-GMM(full)-std_False_center_False-d_5-full/res.dat'
    res = check(in_file)
    ...
    in_file = 'offline/out-kjl-tune_qs_k/src_dst/iat_size-header_False/CTU1/before_proj_False-gs_True/KJL-QS-GMM(full)-std_False_center_False-d_5-full/res.dat'
    res = check(in_file)
    ...
    in_file = 'offline/out-kjl-tune_qs_k/src_dst/iat_size-header_False/SFRIG1_2020/before_proj_False-gs_True/KJL-QS-GMM(full)-std_False_center_False-d_5-full/res.dat'
    res = check(in_file)
    ...
    in_file = 'offline/out-kjl-tune_qs_k/src_dst/iat_size-header_False/UNB345_3/before_proj_False-gs_True/KJL-QS-GMM(full)-std_False_center_False-d_5-full/res.dat'
    res = check(in_file)
