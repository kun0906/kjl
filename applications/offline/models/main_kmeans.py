...
from kjl.models.seek_mode import meanshift_seek_modes, quickshift_seek_modes
from kjl.utils.tool import execute_time, dump_data, load_data, data_info
from offline._speedup_kmeans import single_main, BASE
...
DATASETS = [
    ...
    #
    # # all smtv datasets are on NOEN server: /opt/smart-tv/roku-data-20190927-182117
