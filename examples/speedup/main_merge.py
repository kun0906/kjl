...
from speedup._merge import _dat2csv, merge_res, merge_ds_res
...
if __name__ == '__main__':
    ...
    if res_type=='ds':
        ...
        in_dir = 'speedup/out'  # neon
        # in_dir = 'speedup/calumet_out-20210204' # calumet
